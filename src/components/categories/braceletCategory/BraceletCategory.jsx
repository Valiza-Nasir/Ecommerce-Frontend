...
import { braceletCategory } from '../../../@api/category/braceletcategory/braceletCategory';
...
`;
function BraceletCategory() {
  const [data,setData]=useState([...braceletCategory]);
  ...
  return (
    ...
    <Heading><h1>BRACELETS</h1></Heading>
    <ContentContainer>
    <p>Showing all {braceletCategory.length} results</p>
    <OptionContainer>
