...
`;
function NeclaceCategory() {
  const[data,setData]=useState([...neclaceCategory]);
  ...
  return (
    ...
    <Heading><h1>NECKLACES</h1></Heading>
    <ContentContainer>
    <p>Showing all {neclaceCategory.length} results</p>
    <OptionContainer>
...
export default NeclaceCategory