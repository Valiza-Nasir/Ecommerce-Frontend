...
import { neclaceCategory } from "../../../@api/category/neclacecategory/neclaceCategory";
...
const MainContainer = styled.div`
  ...
  `
function NeclaceDetail() {
  const { id } = useParams();
  const product = neclaceCategory.find((item) => item.id === parseInt(id)); 
  console.log('images of neclace',product.images);
  ...
  return (
    ...
    <MainContainer>
           {neclaceCategory.length > 0 ? (
             neclaceCategory.map((item) => (
